...
def pagina_bienvenida(parent):
    crear_cabecera(parent, "Bienvenido a LyndsGO", "EL sistema operativo más épico.")
    anadirImagen(parent, "welcome.png", resolucion=(680, 180))
    anadirTexto(parent, "Este asistente te guiará sobre cómo utilizar LyndsGO.")
    anadirTexto(parent, "Puedes cerrar la ventana si quieres.")
...
def pagina_final(parent):
    ...
    anadirImagen(parent, "welcome.png", resolucion=(680, 180))
    anadirTexto(parent, "Ya puedes cerrar este asistente y adentrarte de lleno en tu nuevo entorno de trabajo. ¡Gracias por instalar LyndsGO!")
